...
type ArtifactLocation struct {
	...
	IPFS *IPFSArtifact `json:"ipfs,omitempty" protobuf:"bytes,8,opt,name=ipfs"`
}
...
type IPFSArtifact struct {
	...
	Hash            string `json:"hash" protobuf:"bytes,1,opt,name=hash"`
	StorageEndpoint string `json:"storageEndpoint" protobuf:"bytes,2,opt,name=storageEndpoint"`
}
